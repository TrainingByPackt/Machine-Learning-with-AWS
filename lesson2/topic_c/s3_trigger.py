...
def lambda_handler(event, context):
    ...
    sentiment_response = comprehend.detect_sentiment(Text = paragraph, LanguageCode = "en")
    print("sentiment_response: \n", sentiment_response)
    
    # call detect_entities()
    entity_response = comprehend.detect_entities(Text = paragraph, LanguageCode = "en")
    print("\n\nentity_response: \n", entity_response)
    
    # call detect_key_phrases()
    key_phases_response = comprehend.detect_key_phrases(Text = paragraph, LanguageCode = "en") 
    print("\n\nkey_phases_response: \n", key_phases_response)
