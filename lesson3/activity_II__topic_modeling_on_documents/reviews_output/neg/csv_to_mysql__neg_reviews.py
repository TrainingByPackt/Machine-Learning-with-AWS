...
# First: “python csv_to_mysql__neg_reviews.py”
#
# Second: uncomment the ‘topic-terms’ section, 
# comment the ‘doc-topics’ section.  
# “python csv_to_mysql__neg_reviews.py”
###########################################################
import csv
import os
import pymysql
...
with conn.cursor() as cur:
	for row in row_list:
		...
		cur.execute("INSERT IGNORE INTO \
			linkedTopicDB2.neg_reviews_topic_terms \
			(topic, term, weight) \
...
#             PRIMARY KEY (id) );") 
# 		cur.execute("INSERT IGNORE INTO \
# 			linkedTopicDB2.neg_reviews_doc_topics \
