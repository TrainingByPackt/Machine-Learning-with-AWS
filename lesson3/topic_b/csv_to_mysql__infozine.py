...
# First: “python csv_to_mysql__infozine.py”
#
# Second: uncomment the ‘topic-terms’ section, 
# comment the ‘doc-topics’ section.  
# “python csv_to_mysql__infozine.py”
###########################################################
...
with conn.cursor() as cur:
	for row in row_list:
		...
		cur.execute("INSERT IGNORE INTO \
			linkedTopicDB2.infozine_topic_terms \
			(topic, term, weight) \
...
#             PRIMARY KEY (id) );") 
# 		cur.execute("INSERT IGNORE INTO \
# 			linkedTopicDB2.infozine_doc_topics \
